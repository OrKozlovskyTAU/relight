...
def generate_random_light_dataset(start_index, n_images, use_gpu=True, show_progress=True):
    """
    ...
    # Disable gloss and diffcol output nodes
    ...
    # Disable nodes
    render_diffcol_png_node.mute = True
    render_glossdir_png_node.mute = True
    render_glossindir_png_node.mute = True
    render_glosscol_png_node.mute = True
    ...
    # Define bounds for random positioning based on the actual box dimensions
    x_range = [x_min, x_max]
    ...
    while count < n_images:
        ...
        # Render image, dirdiffuse, and indirdiff as pngs
